...
"""seatrack"""
trackers.extend(trackerlist(name='seatrack', parameter_name='vitb_1k_mae_ea_32x4_ep350', dataset_name=dataset_name,
                            run_ids=None, display_name='SEATrack-1k'))
trackers.extend(trackerlist(name='seatrack', parameter_name='vitb_21k_mae_ea_32x4_ep350', dataset_name=dataset_name,
                            run_ids=None, display_name='SEATrack-21k'))
